...
@property (readonly, nonatomic, strong, nullable) GFPVastBaseResource *nasResource;
@property (readonly, nonatomic, strong) NSString *clickThrough;
@property (readonly, nonatomic, strong) NSArray <GFPVastImpression *>*nasClickTracking;

- (instancetype)initWithNasVast:(GFPVastNonLinearAd *)nonLinearVastAd
                          error:(GFPError * _Nullable * _Nullable)aError;
@end


// MARK: - RemindAd
@interface GFPRemindAd : NSObject <GFPNASTrackingWrapper>
...
- (instancetype)initWithNasVast:(GFPVastNonLinearAds *)nonLinearVastAds
                      nonLinear:(NonLinear *)aNonLinear
                           info:(GFPNasNonLinearRemind * _Nullable)aInfo error:(GFPError * _Nullable * _Nullable)aError;
